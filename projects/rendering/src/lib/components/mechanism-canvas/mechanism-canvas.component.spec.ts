/**
 * Unit tests for MechanismCanvas component.
 *
 * Tests verify:
...
import { MechanismCanvasComponent } from './mechanism-canvas.component';
import type { SimulationStateV1 } from 'simulation';
import type { ThemeV1 } from '../../adapter/types';

describe('MechanismCanvasComponent', () => {
  let component: MechanismCanvasComponent;
  let fixture: ComponentFixture<MechanismCanvasComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MechanismCanvasComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(MechanismCanvasComponent);
